...
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vivado_HLS/2017.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vivado_HLS/2017.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vivado_HLS/2017.2/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vivado_HLS/2017.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx/Vivado_HLS/2017.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolveMedium.autotvin.dat"
	set constFileTvOut       "convolveMedium.autotvout.dat"
	set constFileHdlTvIn     "convolveMedium.autohdltvin.dat"
	set constFileHdlTvOut    "convolveMedium.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
