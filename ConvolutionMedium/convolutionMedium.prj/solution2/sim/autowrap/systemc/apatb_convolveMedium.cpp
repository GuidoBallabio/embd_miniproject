...
#define AUTOTB_TVIN_in_r  "../tv/cdatafile/c.convolveMedium.autotvin_in_r.dat"
// wrapc file define: "out_r"
#define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.convolveMedium.autotvout_out_r.dat"
// wrapc file define: "krnl"
#define AUTOTB_TVIN_krnl  "../tv/cdatafile/c.convolveMedium.autotvin_krnl.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "out_r"
#define AUTOTB_TVOUT_PC_out_r  "../tv/rtldatafile/rtl.convolveMedium.autotvout_out_r.dat"
...
char krnl[3][3])
{
						...
						// celement: out(15, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 255; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 255; i_1 += 1)
								{
									...
									// output_type_conversion : (out_lv0_0_255_1_lv1_0_255_1[hls_map_index]).to_uint64()
									if (&(out[0][0]) != NULL) // check the null address if the c port is array or others
									{
										out[i_0][i_1] = (out_lv0_0_255_1_lv1_0_255_1[hls_map_index]).to_uint64();
										hls_map_index++;
									}
								}
							}
	...
	else
	{
		...
		tcl_file.set_num(65536, &tcl_file.in_r_depth);
		...
		sc_bv<8>* krnl_tvin_wrapc_buffer = new sc_bv<8>[9];
				...
				// celement: krnl(7, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 2; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 2; i_1 += 1)
						{
							...
							// input_type_conversion : krnl[i_0][i_1]
							if (&(krnl[0][0]) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<8> krnl_tmp_mem;
								krnl_tmp_mem = krnl[i_0][i_1];
								krnl_tvin_wrapc_buffer[hls_map_index].range(7, 0) = krnl_tmp_mem.range(7, 0);
                                 		       hls_map_index++;
							}
						}
					}
...
// [call_c_dut] ---------->
		...
		tcl_file.set_num(65536, &tcl_file.out_r_depth);
