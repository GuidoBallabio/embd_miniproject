...
if {[file isfile convolveMedium.autotvin.dat]} {
	file delete -force convolveMedium.autotvin.dat
}

if {[file isfile convolveMedium.autotvout.dat]} {
	file delete -force convolveMedium.autotvout.dat
}
