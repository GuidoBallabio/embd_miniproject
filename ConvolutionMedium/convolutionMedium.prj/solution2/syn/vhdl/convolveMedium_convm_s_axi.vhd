...
end entity convolveMedium_convm_s_axi;
...
architecture behave of convolveMedium_convm_s_axi is
    ...
    component convolveMedium_convm_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component convolveMedium_convm_s_axi_ram;
...
port map (
     ...
     q1       => int_out_r_q1);
-- int_krnl
int_krnl : convolveMedium_convm_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
...
entity convolveMedium_convm_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity convolveMedium_convm_s_axi_ram;

architecture behave of convolveMedium_convm_s_axi_ram is
