...
#ifndef __convolveMedium_mabkb__HH__
#define __convolveMedium_mabkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolveMedium_mabkb) {
    ...
    SC_CTOR(convolveMedium_mabkb):  simcore_mac_0_U ("simcore_mac_0_U") {
