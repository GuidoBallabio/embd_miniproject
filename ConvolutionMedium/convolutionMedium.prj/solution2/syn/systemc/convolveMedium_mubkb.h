...
#ifndef __convolveMedium_mubkb__HH__
#define __convolveMedium_mubkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolveMedium_mubkb) {
    ...
    SC_CTOR(convolveMedium_mubkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
