...
#ifndef __convolveMedium_mudEe__HH__
#define __convolveMedium_mudEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolveMedium_mudEe) {
    ...
    SC_CTOR(convolveMedium_mudEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
