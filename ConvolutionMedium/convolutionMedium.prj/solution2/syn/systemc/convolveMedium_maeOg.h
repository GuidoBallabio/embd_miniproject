...
#ifndef __convolveMedium_maeOg__HH__
#define __convolveMedium_maeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolveMedium_maeOg) {
    ...
    SC_CTOR(convolveMedium_maeOg):  simcore_mac_1_U ("simcore_mac_1_U") {
