...
HD_PWD='C:/Users/au513437/Desktop/embd_miniproject/ConvolutionMedium/convolutionMedium.prj/solution2/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log convolveMedium.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source convolveMedium.tcl -notrace
