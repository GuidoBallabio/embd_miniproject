...
HD_PWD='C:/Users/au513437/Desktop/embd_miniproject/ConvolutionMedium/convolutionMedium.prj/solution2/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convolveMedium.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convolveMedium.tcl
