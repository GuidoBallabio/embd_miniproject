...
set Library     "hls"
set IPName      "convolveMedium"
set Version     "1.0"
set DisplayName "Convolvemedium"
set Revision    "1812191244"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "convolveMedium"
...
set Interfaces {
    s_axi_convm {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_convm"
        param_prefix "C_S_AXI_CONVM"
        addr_bits "19"
        ...
        memories "in_r {base_address 131072 range 131072} out_r {base_address 262144 range 131072} krnl {base_address 393216 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 8383 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/au513437/Desktop/embd_miniproject/ConvolutionMedium/Convolution.cpp}
if {$enable_xo_gen} {
