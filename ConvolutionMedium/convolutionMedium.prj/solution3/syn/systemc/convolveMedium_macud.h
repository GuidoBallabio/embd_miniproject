...
#ifndef __convolveMedium_macud__HH__
#define __convolveMedium_macud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolveMedium_macud) {
    ...
    SC_CTOR(convolveMedium_macud):  simcore_mac_1_U ("simcore_mac_1_U") {
