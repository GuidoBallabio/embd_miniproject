...
set Interfaces {
    s_axi_conv {
        ...
        memories "in_r {base_address 8192 range 8192} out_r {base_address 16384 range 8192} krnl {base_address 24576 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 368882 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/au513437/Desktop/embd_miniproject/Convolution/Convolution.cpp}
if {$enable_xo_gen} {
