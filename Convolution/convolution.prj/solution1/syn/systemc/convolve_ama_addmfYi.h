...
#ifndef __convolve_ama_addmfYi__HH__
#define __convolve_ama_addmfYi__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_ama_addmfYi) {
    ...
    SC_CTOR(convolve_ama_addmfYi):  simcore_ama_0_U ("simcore_ama_0_U") {
