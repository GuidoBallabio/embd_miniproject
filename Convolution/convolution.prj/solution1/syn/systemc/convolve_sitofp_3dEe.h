...
#ifndef __convolve_sitofp_3dEe__HH__
#define __convolve_sitofp_3dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_sitofp_3dEe) {
    ...
    SC_CTOR(convolve_sitofp_3dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
