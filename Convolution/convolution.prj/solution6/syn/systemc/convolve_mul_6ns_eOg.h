...
#ifndef __convolve_mul_6ns_eOg__HH__
#define __convolve_mul_6ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_mul_6ns_eOg) {
    ...
    SC_CTOR(convolve_mul_6ns_eOg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
