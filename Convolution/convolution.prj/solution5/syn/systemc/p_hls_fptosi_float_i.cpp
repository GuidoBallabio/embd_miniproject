...
p_hls_fptosi_float_i::p_hls_fptosi_float_i(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_41_fu_149_p1);
    ...
    sc_trace(mVcdFile, tmp_41_fu_149_p1, "tmp_41_fu_149_p1");
...
void p_hls_fptosi_float_i::thread_p_Val2_2_fu_163_p3() {
    p_Val2_2_fu_163_p3 = (!isNeg_reg_196.read()[0].is_01())? sc_lv<15>(): ((isNeg_reg_196.read()[0].to_bool())? tmp_41_fu_149_p1.read(): tmp_s_fu_153_p4.read());
}
...
void p_hls_fptosi_float_i::thread_tmp_41_fu_149_p1() {
    tmp_41_fu_149_p1 = esl_zext<15,1>(tmp_fu_141_p3.read());
}
