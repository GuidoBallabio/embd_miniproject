...
#ifndef __convolve_ama_addmcud__HH__
#define __convolve_ama_addmcud__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_ama_addmcud) {
    ...
    SC_CTOR(convolve_ama_addmcud):  simcore_ama_0_U ("simcore_ama_0_U") {
