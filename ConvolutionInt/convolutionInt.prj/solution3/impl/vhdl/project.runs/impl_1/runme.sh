...
HD_PWD='C:/Users/au513437/Desktop/embd_miniproject/ConvolutionInt/convolutionInt.prj/solution3/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log convolve.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source convolve.tcl -notrace
