...
#ifndef __convolve_mac_muladEe__HH__
#define __convolve_mac_muladEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_mac_muladEe) {
    ...
    SC_CTOR(convolve_mac_muladEe):  simcore_mac_0_U ("simcore_mac_0_U") {
