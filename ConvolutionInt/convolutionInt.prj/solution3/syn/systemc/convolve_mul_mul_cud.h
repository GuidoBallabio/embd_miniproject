...
#ifndef __convolve_mul_mul_cud__HH__
#define __convolve_mul_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_mul_mul_cud) {
    ...
    SC_CTOR(convolve_mul_mul_cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
