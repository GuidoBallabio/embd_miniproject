...
#ifndef __convolve_mul_6ns_bkb__HH__
#define __convolve_mul_6ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_mul_6ns_bkb) {
    ...
    SC_CTOR(convolve_mul_6ns_bkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
