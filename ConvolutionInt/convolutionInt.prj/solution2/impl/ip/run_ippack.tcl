...
set Interfaces {
    s_axi_conv {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_conv"
        param_prefix "C_S_AXI_CONV"
        addr_bits "15"
        ...
        memories "in_r {base_address 8192 range 8192} out_r {base_address 16384 range 8192} krnl {base_address 24576 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 32498 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/au513437/Desktop/embd_miniproject/ConvolutionInt/Convolution.cpp}
if {$enable_xo_gen} {
