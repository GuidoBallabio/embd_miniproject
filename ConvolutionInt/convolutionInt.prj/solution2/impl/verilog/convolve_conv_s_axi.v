...
localparam
    ...
    ADDR_IER        = 15'h0008,
    ADDR_ISR        = 15'h000c,
    ADDR_IN_R_BASE  = 15'h2000,
    ADDR_IN_R_HIGH  = 15'h3fff,
    ADDR_OUT_R_BASE = 15'h4000,
    ADDR_OUT_R_HIGH = 15'h5fff,
    ADDR_KRNL_BASE  = 15'h6000,
    ADDR_KRNL_HIGH  = 15'h600f,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
assign RVALID  = (rstate == RDDATA) & !int_in_r_read & !int_out_r_read & !int_krnl_read;
...
// krnl
assign int_krnl_address0  = krnl_address0 >> 2;
assign int_krnl_ce0       = krnl_ce0;
assign int_krnl_we0       = 1'b0;
assign int_krnl_be0       = 1'b0;
assign int_krnl_d0        = 1'b0;
assign krnl_q0            = int_krnl_q0 >> (int_krnl_shift * 8);
assign int_krnl_address1  = ar_hs? raddr[3:2] : waddr[3:2];
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (krnl_ce0)
            int_krnl_shift <= krnl_address0[1:0];
    end
end
