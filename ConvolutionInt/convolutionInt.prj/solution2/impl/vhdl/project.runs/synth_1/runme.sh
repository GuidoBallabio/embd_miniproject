...
HD_PWD='C:/Users/au513437/Desktop/embd_miniproject/ConvolutionInt/convolutionInt.prj/solution2/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convolve.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convolve.tcl
