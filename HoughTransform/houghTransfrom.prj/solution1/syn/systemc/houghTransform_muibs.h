...
#ifndef __houghTransform_muibs__HH__
#define __houghTransform_muibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muibs) {
    ...
    SC_CTOR(houghTransform_muibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
