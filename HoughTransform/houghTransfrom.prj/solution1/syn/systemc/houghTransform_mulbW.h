...
#ifndef __houghTransform_mulbW__HH__
#define __houghTransform_mulbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_mulbW) {
    ...
    SC_CTOR(houghTransform_mulbW):  ACMP_mul_us_U ("ACMP_mul_us_U") {
