...
#ifndef __houghTransform_onMgi_H__
#define __houghTransform_onMgi_H__
...
struct houghTransform_onMgi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(houghTransform_onMgi_ram) {
...
SC_MODULE(houghTransform_onMgi) {
...
houghTransform_onMgi_ram* meminst;


SC_CTOR(houghTransform_onMgi) {
meminst = new houghTransform_onMgi_ram("houghTransform_onMgi_ram");
