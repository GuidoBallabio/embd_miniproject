...
#ifndef __houghTransform_siRg6__HH__
#define __houghTransform_siRg6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_siRg6) {
    ...
    SC_CTOR(houghTransform_siRg6):  ACMP_sitofp_U ("ACMP_sitofp_U") {
