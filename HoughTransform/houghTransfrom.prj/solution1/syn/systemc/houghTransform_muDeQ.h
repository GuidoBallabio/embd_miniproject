...
#ifndef __houghTransform_muDeQ__HH__
#define __houghTransform_muDeQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muDeQ) {
    ...
    SC_CTOR(houghTransform_muDeQ):  ACMP_mul_us_U ("ACMP_mul_us_U") {
