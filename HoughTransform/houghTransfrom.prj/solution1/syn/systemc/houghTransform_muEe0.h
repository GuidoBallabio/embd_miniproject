...
#ifndef __houghTransform_muEe0__HH__
#define __houghTransform_muEe0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muEe0) {
    ...
    SC_CTOR(houghTransform_muEe0):  ACMP_mul_us_U ("ACMP_mul_us_U") {
