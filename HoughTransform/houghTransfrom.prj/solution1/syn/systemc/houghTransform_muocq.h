...
#ifndef __houghTransform_muocq__HH__
#define __houghTransform_muocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muocq) {
    ...
    SC_CTOR(houghTransform_muocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
