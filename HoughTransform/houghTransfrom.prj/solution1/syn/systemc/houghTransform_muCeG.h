...
#ifndef __houghTransform_muCeG__HH__
#define __houghTransform_muCeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muCeG) {
    ...
    SC_CTOR(houghTransform_muCeG):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
