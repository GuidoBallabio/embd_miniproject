...
#ifndef __houghTransform_mujbC__HH__
#define __houghTransform_mujbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_mujbC) {
    ...
    SC_CTOR(houghTransform_mujbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
