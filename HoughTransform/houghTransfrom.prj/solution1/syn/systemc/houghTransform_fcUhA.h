...
#ifndef __houghTransform_fcUhA__HH__
#define __houghTransform_fcUhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_fcUhA) {
    ...
    SC_CTOR(houghTransform_fcUhA):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
