...
#ifndef __houghTransform_mupcA__HH__
#define __houghTransform_mupcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_mupcA) {
    ...
    SC_CTOR(houghTransform_mupcA):  ACMP_mul_su_U ("ACMP_mul_su_U") {
