...
#ifndef __houghTransform_ma0iy__HH__
#define __houghTransform_ma0iy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_ma0iy) {
    ...
    SC_CTOR(houghTransform_ma0iy):  simcore_mac_1_U ("simcore_mac_1_U") {
