...
#ifndef __houghTransform_muFfa__HH__
#define __houghTransform_muFfa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muFfa) {
    ...
    SC_CTOR(houghTransform_muFfa):  ACMP_mul_us_U ("ACMP_mul_us_U") {
