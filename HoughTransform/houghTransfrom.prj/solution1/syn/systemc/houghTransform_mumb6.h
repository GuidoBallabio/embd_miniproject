...
#ifndef __houghTransform_mumb6__HH__
#define __houghTransform_mumb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_mumb6) {
    ...
    SC_CTOR(houghTransform_mumb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {
