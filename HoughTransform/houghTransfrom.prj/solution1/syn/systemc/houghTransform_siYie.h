...
#ifndef __houghTransform_siYie__HH__
#define __houghTransform_siYie__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_siYie) {
    ...
    SC_CTOR(houghTransform_siYie):  ACMP_sitodp_U ("ACMP_sitodp_U") {
