...
#ifndef __houghTransform_maLf8_H__
#define __houghTransform_maLf8_H__
...
struct houghTransform_maLf8_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(houghTransform_maLf8_ram) {
...
SC_MODULE(houghTransform_maLf8) {
...
houghTransform_maLf8_ram* meminst;


SC_CTOR(houghTransform_maLf8) {
meminst = new houghTransform_maLf8_ram("houghTransform_maLf8_ram");
