...
entity generic_sincos_hlBew_rom is 
    generic(
             dwidth     : integer := 23; 
             awidth     : integer := 7; 
...
architecture rtl of generic_sincos_hlBew_rom is 
...
entity generic_sincos_hlBew is
    generic (
...
architecture arch of generic_sincos_hlBew is
    component generic_sincos_hlBew_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    generic_sincos_hlBew_rom_U :  component generic_sincos_hlBew_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
