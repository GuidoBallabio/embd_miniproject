...
entity houghTransform_onMgi_rom is 
    generic(
             dwidth     : integer := 24; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of houghTransform_onMgi_rom is 
...
entity houghTransform_onMgi is
    generic (
...
architecture arch of houghTransform_onMgi is
    component houghTransform_onMgi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    houghTransform_onMgi_rom_U :  component houghTransform_onMgi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
