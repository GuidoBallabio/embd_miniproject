...
entity houghTransform_maLf8_rom is 
    generic(
             dwidth     : integer := 23; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of houghTransform_maLf8_rom is 
...
entity houghTransform_maLf8 is
    generic (
...
architecture arch of houghTransform_maLf8 is
    component houghTransform_maLf8_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    houghTransform_maLf8_rom_U :  component houghTransform_maLf8_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
