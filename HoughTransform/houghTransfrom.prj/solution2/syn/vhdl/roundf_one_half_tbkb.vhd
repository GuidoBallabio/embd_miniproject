...
entity roundf_one_half_tbkb_rom is 
    generic(
             dwidth     : integer := 24; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of roundf_one_half_tbkb_rom is 
...
entity roundf_one_half_tbkb is
    generic (
...
architecture arch of roundf_one_half_tbkb is
    component roundf_one_half_tbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    roundf_one_half_tbkb_rom_U :  component roundf_one_half_tbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
