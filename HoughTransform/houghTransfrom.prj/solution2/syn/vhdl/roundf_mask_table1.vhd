...
entity roundf_mask_table1_rom is 
    generic(
             dwidth     : integer := 23; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of roundf_mask_table1_rom is 
...
architecture arch of roundf_mask_table1 is
    component roundf_mask_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    roundf_mask_table1_rom_U :  component roundf_mask_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
