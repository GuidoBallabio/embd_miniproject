...
#ifndef __houghTransform_maZio__HH__
#define __houghTransform_maZio__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_maZio) {
    ...
    SC_CTOR(houghTransform_maZio):  simcore_mac_1_U ("simcore_mac_1_U") {
