...
#ifndef __houghTransform_siWhU__HH__
#define __houghTransform_siWhU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_siWhU) {
    ...
    SC_CTOR(houghTransform_siWhU):  ACMP_sitodp_U ("ACMP_sitodp_U") {
