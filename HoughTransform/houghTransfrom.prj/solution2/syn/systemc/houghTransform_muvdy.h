...
#ifndef __houghTransform_muvdy__HH__
#define __houghTransform_muvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muvdy) {
    ...
    SC_CTOR(houghTransform_muvdy):  ACMP_mul_su_U ("ACMP_mul_su_U") {
