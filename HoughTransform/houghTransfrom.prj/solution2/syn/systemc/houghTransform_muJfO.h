...
#ifndef __houghTransform_muJfO__HH__
#define __houghTransform_muJfO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muJfO) {
    ...
    SC_CTOR(houghTransform_muJfO):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
