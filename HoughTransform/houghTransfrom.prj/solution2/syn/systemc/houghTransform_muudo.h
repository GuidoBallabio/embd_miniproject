...
#ifndef __houghTransform_muudo__HH__
#define __houghTransform_muudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muudo) {
    ...
    SC_CTOR(houghTransform_muudo):  ACMP_mul_su_U ("ACMP_mul_su_U") {
