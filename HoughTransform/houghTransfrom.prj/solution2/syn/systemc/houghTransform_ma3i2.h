...
#ifndef __houghTransform_ma3i2__HH__
#define __houghTransform_ma3i2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_ma3i2) {
    ...
    SC_CTOR(houghTransform_ma3i2):  simcore_mac_5_U ("simcore_mac_5_U") {
