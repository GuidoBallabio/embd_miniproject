...
#ifndef __houghTransform_fcShg__HH__
#define __houghTransform_fcShg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_fcShg) {
    ...
    SC_CTOR(houghTransform_fcShg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
