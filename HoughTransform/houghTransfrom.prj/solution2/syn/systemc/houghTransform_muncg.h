...
#ifndef __houghTransform_muncg__HH__
#define __houghTransform_muncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muncg) {
    ...
    SC_CTOR(houghTransform_muncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
