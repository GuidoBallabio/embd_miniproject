...
#ifndef __houghTransform_siPgM__HH__
#define __houghTransform_siPgM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_siPgM) {
    ...
    SC_CTOR(houghTransform_siPgM):  ACMP_sitofp_U ("ACMP_sitofp_U") {
