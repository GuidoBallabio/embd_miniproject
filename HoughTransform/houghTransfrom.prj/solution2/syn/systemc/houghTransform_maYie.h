...
#ifndef __houghTransform_maYie__HH__
#define __houghTransform_maYie__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_maYie) {
    ...
    SC_CTOR(houghTransform_maYie):  simcore_mac_0_U ("simcore_mac_0_U") {
