...
#ifndef __roundf_mask_table1_H__
#define __roundf_mask_table1_H__
...
struct roundf_mask_table1_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(roundf_mask_table1_ram) {
...
roundf_mask_table1_ram* meminst;


SC_CTOR(roundf_mask_table1) {
meminst = new roundf_mask_table1_ram("roundf_mask_table1_ram");
