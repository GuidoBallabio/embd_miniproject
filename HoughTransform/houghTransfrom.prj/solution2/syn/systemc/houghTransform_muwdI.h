...
#ifndef __houghTransform_muwdI__HH__
#define __houghTransform_muwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muwdI) {
    ...
    SC_CTOR(houghTransform_muwdI):  ACMP_mul_su_U ("ACMP_mul_su_U") {
