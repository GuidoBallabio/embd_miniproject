...
#ifndef __houghTransform_ma2iS__HH__
#define __houghTransform_ma2iS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_ma2iS) {
    ...
    SC_CTOR(houghTransform_ma2iS):  simcore_mac_4_U ("simcore_mac_4_U") {
