...
#ifndef __houghTransform_ma4jc__HH__
#define __houghTransform_ma4jc__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_ma4jc) {
    ...
    SC_CTOR(houghTransform_ma4jc):  simcore_mac_6_U ("simcore_mac_6_U") {
