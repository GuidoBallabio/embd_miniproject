...
#ifndef __houghTransform_muXh4__HH__
#define __houghTransform_muXh4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muXh4) {
    ...
    SC_CTOR(houghTransform_muXh4):  ACMP_smul_us_U ("ACMP_smul_us_U") {
