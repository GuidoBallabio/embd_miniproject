...
#ifndef __houghTransform_muzec__HH__
#define __houghTransform_muzec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muzec) {
    ...
    SC_CTOR(houghTransform_muzec):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
