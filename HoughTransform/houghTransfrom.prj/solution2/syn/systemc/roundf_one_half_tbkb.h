...
#ifndef __roundf_one_half_tbkb_H__
#define __roundf_one_half_tbkb_H__
...
struct roundf_one_half_tbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(roundf_one_half_tbkb_ram) {
...
SC_MODULE(roundf_one_half_tbkb) {
...
roundf_one_half_tbkb_ram* meminst;


SC_CTOR(roundf_one_half_tbkb) {
meminst = new roundf_one_half_tbkb_ram("roundf_one_half_tbkb_ram");
