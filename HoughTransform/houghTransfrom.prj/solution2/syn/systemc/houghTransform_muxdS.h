...
#ifndef __houghTransform_muxdS__HH__
#define __houghTransform_muxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muxdS) {
    ...
    SC_CTOR(houghTransform_muxdS):  ACMP_mul_su_U ("ACMP_mul_su_U") {
