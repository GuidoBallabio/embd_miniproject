...
#ifndef __houghTransform_ma1iI__HH__
#define __houghTransform_ma1iI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_ma1iI) {
    ...
    SC_CTOR(houghTransform_ma1iI):  simcore_mac_3_U ("simcore_mac_3_U") {
