...
#ifndef __houghTransform_muGfk__HH__
#define __houghTransform_muGfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muGfk) {
    ...
    SC_CTOR(houghTransform_muGfk):  ACMP_mul_su_U ("ACMP_mul_su_U") {
