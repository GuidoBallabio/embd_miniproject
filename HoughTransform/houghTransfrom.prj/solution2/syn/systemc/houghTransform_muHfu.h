...
#ifndef __houghTransform_muHfu__HH__
#define __houghTransform_muHfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muHfu) {
    ...
    SC_CTOR(houghTransform_muHfu):  ACMP_mul_su_U ("ACMP_mul_su_U") {
