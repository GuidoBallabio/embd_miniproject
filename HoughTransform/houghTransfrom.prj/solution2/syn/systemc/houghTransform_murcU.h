...
#ifndef __houghTransform_murcU__HH__
#define __houghTransform_murcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_murcU) {
    ...
    SC_CTOR(houghTransform_murcU):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
