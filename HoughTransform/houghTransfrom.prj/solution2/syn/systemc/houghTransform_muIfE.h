...
#ifndef __houghTransform_muIfE__HH__
#define __houghTransform_muIfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muIfE) {
    ...
    SC_CTOR(houghTransform_muIfE):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
