...
#ifndef __houghTransform_muKfY__HH__
#define __houghTransform_muKfY__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muKfY) {
    ...
    SC_CTOR(houghTransform_muKfY):  ACMP_mul_us_U ("ACMP_mul_us_U") {
