...
#ifndef __houghTransform_mutde__HH__
#define __houghTransform_mutde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_mutde) {
    ...
    SC_CTOR(houghTransform_mutde):  ACMP_mul_su_U ("ACMP_mul_su_U") {
