...
#ifndef __generic_sincos_hlmb6_H__
#define __generic_sincos_hlmb6_H__
...
struct generic_sincos_hlmb6_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(generic_sincos_hlmb6_ram) {
...
SC_MODULE(generic_sincos_hlmb6) {
...
generic_sincos_hlmb6_ram* meminst;


SC_CTOR(generic_sincos_hlmb6) {
meminst = new generic_sincos_hlmb6_ram("generic_sincos_hlmb6_ram");
