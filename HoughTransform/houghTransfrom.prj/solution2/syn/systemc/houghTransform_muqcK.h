...
#ifndef __houghTransform_muqcK__HH__
#define __houghTransform_muqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_muqcK) {
    ...
    SC_CTOR(houghTransform_muqcK):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
