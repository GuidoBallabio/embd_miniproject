...
#ifndef __houghTransform_musc4__HH__
#define __houghTransform_musc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(houghTransform_musc4) {
    ...
    SC_CTOR(houghTransform_musc4):  ACMP_mul_su_U ("ACMP_mul_su_U") {
